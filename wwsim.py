...
class Simulation:
    ...
    def generate_simulation(self, test_dungeon=None):
        if test_dungeon is None:
            # Set wumpus location
...
if len(sys.argv) == 2:
    if arglist[1].lower() == '-gui':
        ...
        sim.generate_simulation(TestDungeon(wumpus_loc=(2, 2), pit_locs=[], gold_loc=(2, 0)))
